...
async function insertUserEmotion(connection, data) {
  ...
  let query =
    "INSERT INTO mlog.userEmotion (uid, genreId, neutral, positive, negative) VALUES ";
  for (const key in data) {
    query += `(${data[key].uid}, ${data[key].genreId}, ${data[key].neutral}, ${data[key].positive}, ${data[key].negative}),`;
  }
